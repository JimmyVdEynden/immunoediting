...
##############################
gene_mhc_nM<- readRDS(file = "temp/wt_out.rds")
...
saveRDS(aff_wt_9_ls,file="temp/TCGA_aff_wt_9_canonical.rds")
saveRDS(TCGA_maf,file="temp/TCGA_maf_canonical.rds")

# Calculate affinities for mut
##############################
gene_mhc_nM<- readRDS(file = "temp/mut_out.rds")
gene_mhc_nM<- gene_mhc_nM[,c("HLA-A02:01", "HLA-A01:01", "HLA-B07:02", "HLA-B08:01", "HLA-C07:01", "HLA-C07:02")]
...
saveRDS(aff_mut_9_ls,file="temp/TCGA_aff_mut_9_canonical.rds")
...
# Save final TCGA_maf
#####################
saveRDS(TCGA_maf,file="data/TCGA_maf_mainHLAType.rds")
...
saveRDS(TCGA_maf_6,file="data/TCGA_maf_mainHLAType_6.rds")
